...
**Koç dışı analistler:** `11_DIS_KAYNAKLAR.md` — Sellcoin, Berk Dinçtürk, Yeşilada, Şatıroğlu, Lafçı, Atılal, Altınocağı, Foneria, **Mesele Ekonomi / Erdal Sağlam**. **Bu dosyadaki hiçbir görüş Koç'a atfedilmez**; Koç'un kendi çerçevesi `06_ANALIZ.md`'dedir.
