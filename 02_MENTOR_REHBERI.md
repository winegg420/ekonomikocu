...
**Güncelleme:** 22 July 2026 15:10 · Paket: `python claude_paket_olustur.py`
...
**Ana tweet tip dağılımı:** vizyon 645 · seviye 1137 · tarih 725 · tez 2649 · yorum 2679
...
| Public | **6702** |
| Ana tweet | **6575** |
| Alıntı (tam / eksik) | **127** (**123** / **4**) |
| Grafikli | **1078** |
| May 2026 öncesi ana | **1440** |
| Aralık | **2019-11-28T23:04:04** → **2026-07-20T21:35:35** |
| Nisan+ metinli ana (abone dönemi) | **5465** |
| **Abone metinli** (`abone_metin: true`) | **3365** |
