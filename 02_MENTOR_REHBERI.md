...
**Güncelleme:** 06 July 2026 19:39 · Paket: `python claude_paket_olustur.py`
...
**Ana tweet tip dağılımı:** vizyon 626 · seviye 1106 · tarih 706 · tez 2591 · yorum 2617
...
| Public | **6533** |
| Ana tweet | **6418** |
| Alıntı (tam / eksik) | **115** (**111** / **4**) |
| Grafikli | **1020** |
| May 2026 öncesi ana | **1439** |
| Aralık | **2019-11-28T23:04:04** → **2026-07-04T20:29:44** |
| Nisan+ metinli ana (abone dönemi) | **5309** |
| **Abone metinli** (`abone_metin: true`) | **3275** |
