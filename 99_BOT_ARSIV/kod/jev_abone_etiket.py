...
def durum_hesapla(k, metin=""):
    ...
    elif k.get("yazar") == "koc" and AKTARIM_IZI.search(metin or ""):
        # Guven yuksek olsa da "... dedi/diyor" gibi ucuncu sahis alintisi olabilir.
        k["durum"], k["nedenler"] = "kontrol", ["atif_supheli"]
    else:
