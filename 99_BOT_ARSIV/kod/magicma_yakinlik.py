...
# Coklu tarama sembol listesi (kullanici tanimi)
SEMBOLLER = [
    "BINANCE:BTCUSDT", "BINANCE:ETHUSDT", "BINANCE:ETHBTC",
    "TVC:DXY", "FX:EURUSD", "FX:GBPUSD", "FX:USDJPY", "OANDA:USDTRY", "FX:USDCHF",
    "FX:AUDUSD", "FX:USDCAD", "FX:NZDUSD", "FX:EURGBP", "FX:EURJPY",
    "OANDA:XAUUSD", "OANDA:XAGUSD", "OANDA:XPTUSD", "OANDA:XPDUSD",
    "TVC:USOIL", "TVC:UKOIL", "COMEX:HG1!",
    "SP:SPX", "TVC:NDX", "DJ:DJI", "TVC:VIX", "TVC:US10Y",
    "CRYPTOCAP:TOTAL", "CRYPTOCAP:BTC.D",
    "BIST:XU100", "BIST:XU030",
    "BIST:THYAO", "BIST:GARAN", "BIST:AKBNK", "BIST:ASELS", "BIST:TUPRS",
    "BIST:SISE", "BIST:KCHOL", "BIST:EREGL", "BIST:BIMAS", "BIST:FROTO",
    "BIST:SAHOL", "BIST:YKBNK", "BIST:ISCTR", "BIST:PGSUS", "BIST:TCELL",
    "BIST:TOASO", "BIST:KOZAL", "BIST:HEKTS", "BIST:PETKM", "BIST:SASA",
    "BIST:TAVHL", "BIST:ARCLK", "BIST:ENKAI", "BIST:EKGYO", "BIST:GUBRF",
    "BIST:OYAKC", "BIST:VESTL", "BIST:TTKOM", "BIST:MGROS", "BIST:DOHOL",
    "BIST:ALARK", "BIST:KONTR", "BIST:ASTOR", "BIST:ULKER", "BIST:AEFES",
    "BIST:CIMSA", "BIST:KRDMD", "BIST:SOKM",
]
