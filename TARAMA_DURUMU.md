...
> **2026-07-17 - 2025-01 sonuna kadar kesintisiz kayit VAR (alt aylarda bosluk/sorun olabilir)**
>
> Hedef: **2025-01-01**'e kadar tum tweet + alinti + #FLOOD
>
> **Tamam mi?** HAYIR — tarama devam etmeli
...
| Ana tweet (metinli) | **6541** |
| Abone (metinli) | **3336** |
| Bos / kilitli (eksik) | **0** |
| Alinti eksik | **4** (+ bekleyen dosya: 10) |
| #FLOOD kok / eksik tahmin | **7** / **1** |
...
1. **Profil** — gunumuzden geriye kaydir (hedef: 2025-01-01)
